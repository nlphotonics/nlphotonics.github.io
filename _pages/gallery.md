...
<div class="row justify-content-sm-center">
    ...
    <div class="col-sm-5 mt-3 mt-md-0">
        {% include figure.html path="assets/img/gallery/IMG_2702.jpg" title="tree" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row justify-content-sm-center">
    ...
    <div class="col-sm-5 mt-3 mt-md-0">
        {% include figure.html path="assets/img/gallery/IMG_2422.jpg" title="dance of fire by shaking my phone" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
